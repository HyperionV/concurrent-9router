...
export default {
  async fetch(request, env, ctx) {
    ...
    newRequestInit.headers.delete("connection");
    newRequestInit.headers.delete("keep-alive");
    newRequestInit.headers.delete("transfer-encoding");
      ...
      return NextResponse.json(
        {
          error:
            ...
            "Failed to upload Worker to Cloudflare",
        },
